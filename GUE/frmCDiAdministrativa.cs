...
namespace GUE
{
    ...
    public partial class frmCDiAdministrativa : Form
    {
        public String operacao = "";
        public string foto = "";
        public frmCDiAdministrativa()
        {
            InitializeComponent();
        }
        ...
        private void btnLocalizar_Click(object sender, EventArgs e)
        {
            ...
            BLLScretariado bll = new BLLScretariado(cx);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //Alterar a sala
                    modelo.SecCod = Convert.ToInt32(txtId.Text);
                    if (this.foto == "Foto Original")
                    {
                        ModeloSecretariado mt = bll.CarregaModeloSecretariado(modelo.SecCod);
        ...
        private void frmCDiAdministrativa_Load(object sender, EventArgs e)
        {
            btnLocalizar_Click(sender, e);
        ...
        private void dvgDados_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                operacao = "alterar";
                txtId.Text = dvgDados.CurrentRow.Cells["id_secretariado"].Value.ToString();
