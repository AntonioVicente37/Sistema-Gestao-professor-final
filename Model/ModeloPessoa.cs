...
namespace Modelo
{
    public class ModeloPessoa
    {
            ...
            public ModeloPessoa(int pecod, int mucod, string pe_nome, string pe_telefone, string pe_BI, byte[] pe_foto, string pe_email, string pe_sexo, DateTime datac, DateTime dataa)
            {
                this.PeCod = pecod;
                this.MuCod = mucod;
                this.Penome = pe_nome;
