...
namespace Modelo
{
    public class ModeloProfessor
    {
        ...
        public ModeloProfessor(int numagente,int mucod ,string pe_nome, string pe_telefone, string pe_BI, byte[] pe_foto, string pe_email, string pe_sexo, DateTime datac, DateTime dataa)
        {
